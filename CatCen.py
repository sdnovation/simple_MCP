...
async def getDevices() -> list[dict[str, Any]]:
    ...
    using this you will get a list of all devices. within the list you can read the attribues like the device name, IP Adress or Name
    example output:
...
async def getDeviceConfig(host: str, ) -> str:
   """
   use the IP Adress of a device to ssh into it. Username and Password are already present in this tool.
